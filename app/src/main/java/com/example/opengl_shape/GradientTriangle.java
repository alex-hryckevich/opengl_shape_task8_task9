...
public class GradientTriangle {
    ...
    public GradientTriangle() {
        ...
        int vertexShader = OpenGLRendererGradientTriangle.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        int fragmentShader = OpenGLRendererGradientTriangle.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
